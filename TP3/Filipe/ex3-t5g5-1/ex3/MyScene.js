    ...
    display() {
        ...
        if (this.objects[this.selectedObject] == this.tangram) {
            if (this.displayNormals) {
                this.tangram.greenSquare.enableNormalViz();
                this.tangram.pinkTriangle.enableNormalViz();
                this.tangram.yellowParallelogram.enableNormalViz();
                this.tangram.redTriangle.enableNormalViz();
                this.tangram.purpleTriangle.enableNormalViz();
                this.tangram.orangeTriangle.enableNormalViz();
                this.tangram.blueTriangle.enableNormalViz();
            } else {
                this.tangram.greenSquare.disableNormalViz();
                this.tangram.pinkTriangle.disableNormalViz();
                this.tangram.yellowParallelogram.disableNormalViz();
                this.tangram.redTriangle.disableNormalViz();
                this.tangram.purpleTriangle.disableNormalViz();
                this.tangram.orangeTriangle.disableNormalViz();
                this.tangram.blueTriangle.disableNormalViz();            
            } 
        }else {
            if (this.displayNormals)
